...
from src.rag_pipelines.legal_relation_normalizer import tokenize_legal_relation_text
...
class NaiveRAG:
    ...
    def index_documents(self, chunks: List[str]) -> None:
        ...
        self.chunks = chunks
        tokenized_chunks = [tokenize_legal_relation_text(chunk) for chunk in chunks]
    ...
    def retrieve(self, query: str, k: int = 5) -> List[str]:
        ...
        if not self.bm25 or not self.chunks:
            ...
            return []
        tokenized_query = tokenize_legal_relation_text(query)
