...
class DenseRAG(NaiveRAG):
    ...
    # ChromaDB's default gRPC message size caps a single batch at ~41 666 items.
    # For large legal corpora, adding all chunks at once silently drops the
    # remainder or raises a gRPC error. We therefore add in smaller batches.
